...
public class FSSCM extends SCM {
     ...
     * <ul>
     * <li>files created or modified since last build time, we only need to check
     * the source folder</li>
     * <li>file deleted since last build time, we have to compare source and
    ...
    public static final class DescriptorImpl extends SCMDescriptor<FSSCM> {
        ...
        public FormValidation doFilterCheck(@QueryParameter final String value) {
            return Jenkins.getActiveInstance().getDescriptorByType(FilterSelector.DescriptorImpl.class)
